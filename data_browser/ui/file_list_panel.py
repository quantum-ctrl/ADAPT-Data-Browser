...
from data_browser.core.data_manager import DataManager, filter_files_by_type
...
class ThumbnailWorker(QRunnable):
    ...
    def __init__(self, filepath: str, colormap: str = 'viridis', invert: bool = False):
        super().__init__()
    ...
    def _apply_colormap(self, gray: np.ndarray) -> np.ndarray:
        ...
        # Get colormap colors
        cmap_colors = COLORMAPS.get(self.colormap, COLORMAPS['viridis'])
